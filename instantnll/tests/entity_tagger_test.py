...
class EntityTaggerTest(ModelTestCase):
    def setUp(self):
        super(EntityTaggerTest, self).setUp()
        self.set_up_model('test_entity_tagger_experiment.jsonnet',
                          'test_entity_tagger_data.txt')

    def test_entity_tagger_can_train_save_and_load(self):
