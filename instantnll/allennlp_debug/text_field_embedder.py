...
@TextFieldEmbedder.register("debug")
    ...
    def forward(self, text_field_input: Dict[str, torch.Tensor],
        ...
        for key in keys:
            ...
            if self._embedder_to_indexer_map is not None:
                print("===DEBUG===")
                print("Using embedder to indexer map.")
                print("===DEBUG===")
                ...
                token_vectors = embedder(*tensors, **forward_params_values)
                print("===DEBUG===")
                print("Not using embedder to indexer map.")
                print("Text_field_input:", text_field_input)
                print("Current key:", key)
                print("Length of tensors:", len(tensors))
                print("Tensors:", tensors)
                print("Embedder:", embedder)
                print("Token vectors:", token_vectors)
                print("Shape of token_vectors:", token_vectors.shape)
                print("===DEBUG===")
